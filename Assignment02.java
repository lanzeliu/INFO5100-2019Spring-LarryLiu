...
public class Assignment2 {
    ...
    public static double insuranceCoverage(Employee employee) {
    	...
    	else if (employee.salary > 35 && employee.salary <= 50) {
    		rate = 0.04;
    	}
    	else if (employee.salary > 50 && employee.salary <= 60) {
    		rate = 0.05;
    	}
    	else if (employee.salary > 60) {
    		rate = 0.06;
    	}
    ...
    public void sortSalary(Employee e1, Employee e2, Employee e3) {
    	...
    	System.out.print(helper1.name + " " + helper2.name + " " + helper3.name);
    }
    ...
    /*
     ...
     Your Answer:
     Because in the function swap, the Employee x and Employee y are parameter. But in the main, the a and b are argument.
     In Java, when calling a function, we can only pass values to functions. But we can not pass the variable itself to functions.
    */
